...
maps.n["<leader>nt"] = { "<cmd>enew<cr>", desc = "New File" }
...
maps.n["<leader>bl"] = {
	function()
		require("astronvim.utils.buffer").close_left()
	end,
...
maps.n["<leader>br"] = {
	function()
		require("astronvim.utils.buffer").close_right()
	end,
...
maps.n["<leader>bse"] = {
	function()
		require("astronvim.utils.buffer").sort("extension")
	end,
	desc = "By extension",
}
maps.n["<leader>bsr"] = {
	function()
		require("astronvim.utils.buffer").sort("unique_path")
	end,
	desc = "By relative path",
}
maps.n["<leader>bsp"] = {
	function()
		require("astronvim.utils.buffer").sort("full_path")
	end,
	desc = "By full path",
}
maps.n["<leader>bsi"] = {
	function()
		require("astronvim.utils.buffer").sort("bufnr")
	end,
...
--   }
-- end
maps.n["<leader>h"] = { "<cmd>ToggleTerm size=20 direction=horizontal<cr>", desc = "ToggleTerm horizontal split" }
maps.n["<leader>m"] = { "<cmd>ToggleTerm direction=float<cr>", desc = "ToggleTerm float" }
